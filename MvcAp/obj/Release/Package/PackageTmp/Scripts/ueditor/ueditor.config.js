...
'fullscreen', 'source', '|', 'undo', 'redo', '|',
			'bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'formatmatch', 'autotypeset', 'blockquote', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist','|',
        ...
        , 'fontfamily': [
            { label: '微軟正黑體', name: '微軟正黑體', val: 'Microsoft JhengHei' },
            { label: '新細明體', name: '新細明體', val: '新細明體' },
